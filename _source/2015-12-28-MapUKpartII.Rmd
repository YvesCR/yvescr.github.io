...
```{r, echo = F, message = F}
# image: https://www.flickr.com/photos/kouroff/
library(ggmap)
library(grid)
library(RColorBrewer)

load(file = "C:/Statistique/MapUK/MapUK/data/map.rdata") # map
load(file = "C:/Statistique/MapUK/MapUK/data/pop2.rdata") # pop2
load(file = "C:/Statistique/MapUK/MapUK/data/pop4.rdata") # pop4
```
...
```{r, echo = F}
load(file = "C:/Statistique/MapUK/MapUK/data/pop6.rdata") # pop6
load(file = "C:/Statistique/MapUK/MapUK/data/pop4c.rdata") # pop4c
# map2 <- get_map(location = c(lon = 0, lat =  51.5), zoom = 8, maptype = "satellite")
# save(map2, file = "C:/YCR Perso/MapUK/data/map2.rdata") # map2
load(file = "C:/Statistique/MapUK/MapUK/data/map2.rdata")
```
